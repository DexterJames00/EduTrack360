...
class Student(db.Model):
    ...
    grade_level = db.Column('grade level', db.String(50), nullable=False)
    section_id = db.Column(db.Integer, db.ForeignKey('sections.id'), nullable=False)
    parent_contact = db.Column(db.String(100))
    school_id = db.Column(db.Integer, db.ForeignKey('schools.id'))
    code = db.Column(db.String(100), nullable=False)
    telegram_chat_id = db.Column(db.String(100), nullable=False)
    telegram_status = db.Column(db.Boolean, nullable=False)
